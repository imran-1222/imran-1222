...
* ⚡ Strong interest in Automation & Industrial AI Solutions
...
* Supporting industrial visualization and control workflows
* Working on automation-based monitoring systems
...
* Performs real-time congestion analysis for smart traffic management
* Implemented Computer Vision techniques for accurate vehicle detection
* Optimized the system for real-time monitoring applications
...
* Integrated local LLMs using Ollama for fully offline real-time Q&A
* Built modular AI agents for ingestion, retrieval & response generation
...
* Visualized emotion confidence and sentiment categories
* Useful for early risk detection and monitoring applications
...
* Compared CNN, LSTM, and ResNet architectures
* Achieved strong classification performance on UrbanSound8K dataset
...
* Managed dynamic seat availability and cancellation flows
* Designed optimized database queries for efficient operations
...
📊 Create more Computer Vision & Automation projects
🌐 Launch a professional portfolio website
💼 Land a role in AI / ML / Cloud domain
